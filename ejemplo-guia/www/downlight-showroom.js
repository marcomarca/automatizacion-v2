// Downlight Showroom v1.0.4
// Custom panel de Home Assistant derivado directamente de panel-backlit-showroom v1.2.0.
// Estado real: switch.interruptor_inteligente_2_switch_4 (muestra Downlights, configurable desde panel_custom).

const DOWNLIGHT_DEFAULTS = Object.freeze({
  ...
  officeOnImage: "/local/downlight/downlight-eg-on.png",
  officeOffImage: "/local/downlight/downlight-eg-off.png",
  panelOnImage: "/local/downlight/downlight-on.png",
  panelOffImage: "/local/downlight/downlight-off.png",
});

class DownlightShowroom extends HTMLElement {
  constructor() {
    super();
  ...
  _config() {
    ...
    const entity = String(raw.entity || DOWNLIGHT_DEFAULTS.entity);
    ...
    const sceneControlEntities = Array.isArray(requestedControls) && requestedControls.length
      ...
      : [...DOWNLIGHT_DEFAULTS.sceneControlEntities];
    ...
    return {
      entity,
      sceneControlEntities,
      officeOnImage: raw.office_on_image || raw.officeOnImage || DOWNLIGHT_DEFAULTS.officeOnImage,
      officeOffImage: raw.office_off_image || raw.officeOffImage || DOWNLIGHT_DEFAULTS.officeOffImage,
      panelOnImage: raw.panel_on_image || raw.panelOnImage || DOWNLIGHT_DEFAULTS.panelOnImage,
      panelOffImage: raw.panel_off_image || raw.panelOffImage || DOWNLIGHT_DEFAULTS.panelOffImage,
    };
  }
  ...
  async _togglePanel() {
    ...
    try {
      if (desired === "on") {
        // Replica la escena de muestra "Downlights" del showroom:
        // apaga el resto del grupo exclusivo y deja encendido solo Downlights.
        ...
        // Apagar desde esta interfaz desactiva la muestra Downlights.
      ...
      this._clearPending();
      this.render();
      console.error("Downlight: error de control", error);
    }
  }
  ...
  render() {
    ...
    const actionLabel = unavailable ? "Circuito no disponible" : visuallyOn ? "Apagar downlight" : "Encender downlight";
    ...
    this.shadowRoot.innerHTML = `
      ...
      <main class="layout ${visuallyOn ? "" : "lights-off"}">
        <section class="office-image" aria-label="Downlights LED empotrados instalados en una sala">
          ...
          <div class="office-image__caption"><span>ILUMINACIÓN PROFESIONAL</span><strong>Downlight de Empotrar</strong></div>
        </section>

        <section class="product-card" aria-label="Descripción y control del downlight LED">
          <div class="topline">
            <div class="warranty">
          ...
          <div class="product-intro">
            ...
            >
              <img src="${this._escape(visuallyOn ? config.panelOnImage : config.panelOffImage)}" alt="Downlight LED de empotrar">
            </button>
            <div class="intro-copy">
              <h1>DOWNLIGHT</h1>
              <p>12 / 18 / <b>24W</b></p>
              <div class="interaction-copy">Circuito Showroom · <strong>Downlights</strong></div>
              ${this._lastError ? `<div class="error-copy">${this._escape(this._lastError)}</div>` : ""}
            </div>
          </div>

          <ul class="reference-specs" aria-label="Características del downlight">
            <li><span><svg viewBox="0 0 28 28"><path d="m7 12 5 4 8-4-5-3 5 4-5 3"/></svg></span>12 / 18 / 24W</li>
            <li><span><svg viewBox="0 0 28 28"><path d="M4 14h20M8 9l-5 5 5 5M20 9l5 5-5 5"/></svg></span>223 x 30 x 205 mm</li>
            <li><span><svg viewBox="0 0 28 28"><text class="letters" x="14" y="17">LM</text></svg></span>2520 lm</li>
            <li><span><svg class="mint" viewBox="0 0 28 28"><path d="M6 17a8 8 0 0 1 16 0"/></svg></span>4000 / 6000K</li>
            ...
            <li><span><svg viewBox="0 0 28 28"><text class="letters" x="14" y="17">IP</text></svg></span>IP20</li>
...
if (!customElements.get("downlight-showroom")) {
  customElements.define("downlight-showroom", DownlightShowroom);
}
