// Panel 3K/6K Showroom v1.0.4
// Custom panel de Home Assistant derivado directamente de panel-backlit-showroom v1.2.0.
// Estado real: switch.interruptor_inteligente_2_switch_1 (muestra Paneles 3k/6k, configurable desde panel_custom).

const PANEL_3K6K_DEFAULTS = Object.freeze({
  ...
  officeOnImage: "/local/paneles3k6k/paneles3k6k-oficina-on.png",
  officeOffImage: "/local/paneles3k6k/paneles3k6k-oficina-off.png",
  panelOnImage: "/local/paneles3k6k/paneles3k6k-on.png",
  panelOffImage: "/local/paneles3k6k/paneles3k6k-off.png",
});

class Panel3K6KShowroom extends HTMLElement {
  constructor() {
    super();
  ...
  _config() {
    ...
    const entity = String(raw.entity || PANEL_3K6K_DEFAULTS.entity);
    ...
    const sceneControlEntities = Array.isArray(requestedControls) && requestedControls.length
      ...
      : [...PANEL_3K6K_DEFAULTS.sceneControlEntities];
    ...
    return {
      entity,
      sceneControlEntities,
      officeOnImage: raw.office_on_image || raw.officeOnImage || PANEL_3K6K_DEFAULTS.officeOnImage,
      officeOffImage: raw.office_off_image || raw.officeOffImage || PANEL_3K6K_DEFAULTS.officeOffImage,
      panelOnImage: raw.panel_on_image || raw.panelOnImage || PANEL_3K6K_DEFAULTS.panelOnImage,
      panelOffImage: raw.panel_off_image || raw.panelOffImage || PANEL_3K6K_DEFAULTS.panelOffImage,
    };
  }
  ...
  async _togglePanel() {
    ...
    try {
      if (desired === "on") {
        // Replica la escena de muestra "Paneles 3k/6k" del showroom:
        // apaga el resto del grupo exclusivo y deja encendido solo Paneles 3k/6k.
        ...
        // Apagar desde esta interfaz desactiva la muestra Paneles 3k/6k.
      ...
      this._clearPending();
      this.render();
      console.error("Panel 3K/6K: error de control", error);
    }
  }
  ...
  render() {
    ...
    const actionLabel = unavailable ? "Circuito no disponible" : visuallyOn ? "Apagar paneles 3K/6K" : "Encender paneles 3K/6K";
    ...
    this.shadowRoot.innerHTML = `
      ...
      <main class="layout ${visuallyOn ? "" : "lights-off"}">
        <section class="office-image" aria-label="Paneles LED 3K/6K instalados en una oficina">
          ...
          <div class="office-image__caption"><span>ILUMINACIÓN PROFESIONAL</span><strong>Paneles 3K / 6K 60x60</strong></div>
        </section>

        <section class="product-card" aria-label="Descripción y control de Paneles 3K/6K">
          <div class="topline">
            <div class="warranty">
          ...
          <div class="product-intro">
            ...
            >
              <img src="${this._escape(visuallyOn ? config.panelOnImage : config.panelOffImage)}" alt="Panel LED 60x60 3K/6K">
            </button>
            <div class="intro-copy">
              <h1>PANEL 3K / 6K</h1>
              <p>60x60 <b>48W</b></p>
              <div class="interaction-copy">Circuito Showroom · <strong>Paneles 3K/6K</strong></div>
              ${this._lastError ? `<div class="error-copy">${this._escape(this._lastError)}</div>` : ""}
            </div>
          </div>

          <ul class="reference-specs" aria-label="Características del panel 3K/6K">
            ...
            <li><span><svg class="mint" viewBox="0 0 28 28"><path d="M6 17a8 8 0 0 1 16 0"/></svg></span>3000K / 6000K</li>
...
if (!customElements.get("panel-3k6k-showroom")) {
  customElements.define("panel-3k6k-showroom", Panel3K6KShowroom);
}
