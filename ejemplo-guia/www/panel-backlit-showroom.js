// Panel Backlit Showroom v1.2.4
// Custom panel de Home Assistant basado en panel-backlit-autonomo-dinamico-corregido-v2.html.
// Estado real: switch.smart_relay_switch_4_switch (configurable desde panel_custom).

const PANEL_BACKLIT_DEFAULTS = Object.freeze({
  ...
  officeOnImage: "/local/panel-backlit/oficinas-paneles-on.png",
  officeOffImage: "/local/panel-backlit/oficinas-paneles-off.png",
  panelOnImage: "/local/panel-backlit/panel-encendido.jpg",
  panelOffImage: "/local/panel-backlit/panel-apagado.png",
});

class PanelBacklitShowroom extends HTMLElement {
  constructor() {
    super();
  ...
  _config() {
    ...
    const entity = String(raw.entity || PANEL_BACKLIT_DEFAULTS.entity);
    ...
    const sceneControlEntities = Array.isArray(requestedControls) && requestedControls.length
      ...
      : [...PANEL_BACKLIT_DEFAULTS.sceneControlEntities];
    ...
    return {
      entity,
      sceneControlEntities,
      officeOnImage: raw.office_on_image || raw.officeOnImage || PANEL_BACKLIT_DEFAULTS.officeOnImage,
      officeOffImage: raw.office_off_image || raw.officeOffImage || PANEL_BACKLIT_DEFAULTS.officeOffImage,
      panelOnImage: raw.panel_on_image || raw.panelOnImage || PANEL_BACKLIT_DEFAULTS.panelOnImage,
      panelOffImage: raw.panel_off_image || raw.panelOffImage || PANEL_BACKLIT_DEFAULTS.panelOffImage,
    };
  }
  ...
  async _togglePanel() {
    ...
    try {
      if (desired === "on") {
        // Replica la escena de muestra "Paneles" del showroom:
        // apaga el resto del grupo exclusivo y deja encendido solo Paneles.
        ...
        // Apagar desde esta interfaz desactiva la muestra Paneles.
      ...
      this._clearPending();
      this.render();
      console.error("Panel Backlit: error de control", error);
    }
  }
  ...
  render() {
    ...
    const actionLabel = unavailable ? "Circuito no disponible" : visuallyOn ? "Apagar paneles" : "Encender paneles";
    ...
    this.shadowRoot.innerHTML = `
      ...
      <main class="layout ${visuallyOn ? "" : "lights-off"}">
        <section class="office-image" aria-label="Paneles LED instalados en una oficina">
          ...
          <div class="office-image__caption"><span>ILUMINACIÓN PROFESIONAL</span><strong>Panel Backlit 60x60</strong></div>
        </section>

        <section class="product-card" aria-label="Descripción y control del panel LED">
          <div class="topline">
            <div class="warranty">
          ...
          <div class="product-intro">
            ...
            >
              <img src="${this._escape(visuallyOn ? config.panelOnImage : config.panelOffImage)}" alt="Panel LED Backlit 60x60">
            </button>
            <div class="intro-copy">
              <h1>PANEL BACKLIT</h1>
              <p>60x60 <b>48W</b></p>
              <div class="interaction-copy">Circuito Showroom · <strong>Paneles</strong></div>
              ${this._lastError ? `<div class="error-copy">${this._escape(this._lastError)}</div>` : ""}
            </div>
          </div>

          <ul class="reference-specs" aria-label="Características del panel">
            <li><span><svg viewBox="0 0 28 28"><path d="m7 12 5 4 8-4-5-3 5 4-5 3"/></svg></span>48W</li>
            <li><span><svg viewBox="0 0 28 28"><path d="M4 14h20M8 9l-5 5 5 5M20 9l5 5-5 5"/></svg></span>600 x 600mm</li>
            <li><span><svg class="mint" viewBox="0 0 28 28"><path d="M6 17a8 8 0 0 1 16 0"/></svg></span>3500 / 4500K / 6500K</li>
            <li><span><svg viewBox="0 0 28 28"><text class="letters" x="14" y="17">CRI</text></svg></span>PF&gt;0.9</li>
            <li><span><svg viewBox="0 0 28 28"><path d="M7 7h14v14H7zM11 7v14M15 7v14M19 7v14M7 11h14M7 15h14M7 19h14"/></svg></span>EPISTAR CHIPS</li>
            <li><span><svg viewBox="0 0 28 28"><path d="M7 7h15l-3 14H4z"/></svg></span>PC</li>
            <li class="install"><span><svg viewBox="0 0 28 28"><path d="m8 8 12 12M20 8 8 20M6 9l3-3 3 3-3 3zM16 19l3-3 3 3-3 3z"/></svg></span><span>DE SOBREPONER<br>- EMPOTRAR - SUSPENDIDO</span></li>
            <li><span><svg viewBox="0 0 28 28"><text class="letters" x="14" y="17">LM</text></svg></span>6000 Lm</li>
            <li><span><svg viewBox="0 0 28 28"><path d="M7 19h14M10 17c-2-2-1-6 2-7v-3h4v3c3 1 4 5 2 7M12 22h4"/></svg></span>125 Lm/W</li>
          </ul>
        </section>
      </main>
    `;
...
if (!customElements.get("panel-backlit-showroom")) {
  customElements.define("panel-backlit-showroom", PanelBacklitShowroom);
}
